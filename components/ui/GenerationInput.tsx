...
import { Box, User, Minus, Plus, Mic, Send, Briefcase } from 'lucide-react';
...
export const GenerationInput: React.FC<GenerationInputProps> = ({ onGenerate, count, setCount, inputRef, stopProp, showTooltip, hideTooltip }) => {
  ...
  return (
    <div className="flex flex-col gap-2 bg-white/10 backdrop-blur-md p-3 rounded-xl border border-white/20 pointer-events-auto" onPointerDown={stopProp} onClick={stopProp}>
